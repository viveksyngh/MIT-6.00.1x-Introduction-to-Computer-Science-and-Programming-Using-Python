...
class TitleTrigger(WordTrigger) :
    ...
    def evaluate(self, story) :
        text = story.getTitle()
        return WordTrigger.isWordIn(self, text)
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == 'TITLE' :
        ...
        newTrigger = AndTrigger(trigger1, trigger2)
        triggerMap[name] = newTrigger
    elif triggerType == 'OR' :
        trigger1 = triggerMap[params[0]]
        trigger2 = triggerMap[params[1]]
        newTrigger = OrTrigger(trigger1, trigger2)
        triggerMap[name] = newTrigger
    elif triggerType == 'NOT' :
        trigger1 = triggerMap[params[0]]
        newTrigger = NotTrigger(trigger1)
        triggerMap[name] = newTrigger
    return newTrigger
