...
WORDLIST_FILENAME = "C:\Users\Vivek\Desktop\MITx 6.00.1x\Code\Week-4\ProblemSet4\ProblemSet4\words.txt"
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True :
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(user_input, new_hand, wordList) :
            ...
            # Otherwise (the word is valid):
                ...
                score = score + getWordScore(user_input, n)
                print '"' + user_input + '"' + " earned " + str(getWordScore(user_input, n)) + " points. Total: " + str(score) + " points"
                # Update the hand 
                new_hand = updateHand(new_hand, user_input) 
                if sum(list(new_hand.values())) == 0 :
                    break        
